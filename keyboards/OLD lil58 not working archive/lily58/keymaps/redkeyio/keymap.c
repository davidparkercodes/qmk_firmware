 ...
 */
    ...
    [_QWERTY] = LAYOUT(
        ...
        MT_ALT_SPACE, MT_LGUI_DEL, KC_BSPC, LT_LOWER_ENT, LT_RAISE_SPACE, KC_BSPC, KC_BSPC, KC_RGUI),
    /* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                   |------+------+------+------+------+------|
 ...
 */
    [_LOWER] = LAYOUT(
        LEFT_THIRD, MIDDLE_THIRD, RIGHT_THIRD, SELECT_COPY, SELECT_PASTE, _______, _______, _______, _______, _______, _______, RESET,
        LEFT_HALF, RIGHT_HALF, KC_PIPE, KC_EQUAL, KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______, _______,
        TOP_LEFT_QUARTER, TOP_RIGHT_QUARTER, KC_BSLS, KC_PLUS, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______, _______,
        BOTTOM_LEFT_QUARTER, BOTTOM_RIGHT_QUARTER, _______, MOVE_LINE_DOWN, MOVE_LINE_UP, COPY_LINE_DOWN, _______, _______, _______, _______, _______, _______, _______, _______,
